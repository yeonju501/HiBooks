                        ...
                        <div class="col-lg-10">
                            <div class="contact-form-inner">
                                ...
                                <form name = "input" method ="post" action ="write.do" enctype = "multipart/form-data">
                                    <!-- <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control" name="writer" placeholder="작성자를 입력 해주세요.*">
                                        </div>
                                    </div> -->
                                    <div class="row">
                                        <div class="col-6">
                                    ...
                                    <div class="contact-submit">
                                        <input type="submit" value="글쓰기 등록" class="wpcf7-form-control wpcf7-submit button" onclick="check()">
