...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/service-order-detail.css">
                    ...
                    <div id="orders" class="tab-pane fade active show" style="margin-top:30px;">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${odResultList}" var="odResult">
	                                    <tr>
	                                        <td><a href="../book/content.do?itemId=${odResult.b_itemId}"><img id="book-img"src="${odResult.b_img }"/></a></td>
	                                        <td><a href="../book/content.do?itemId=${odResult.b_itemId}">${odResult.b_title}</a></td>
	                                        <td>${odResult.b_price }</td>
	                                        <td>${odResult.od_vol }</td>
	                                        <td>${odResult.od_total }</td>
	                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
