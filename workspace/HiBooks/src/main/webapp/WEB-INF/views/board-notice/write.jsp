                    ...
                    <div class="col-lg-10">
                        <div class="contact-form-inner">
                            ...
                            <form name="input" method="post" action ="write.do" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control" name = "bn_subject" placeholder="글제목을 입력해주세요*">
                                        
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control" name = "bn_email" placeholder="관리자 이메일 입력칸">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                    	<textarea id="summernote" name="bn_content"></textarea>                                      
                                    </div>
                                </div>
                                <div class = "row">
                                    <div class = "col">
