    	...
    	<div class="container" role="main">
			...
			<form name="input" method="post" action="write.do" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="m_email" value="${loginUser}" readonly>
				</div>
				<div class="mb-3">
			...
			<div>
				<button type="button" value="전송" class="button button--list" onclick="check()">등록</button>
				<a href="list.do">
				<button type="button" value="목록" class="button button--list" >목록</button>
				</a>
