			...
			<form name="input" method="post" action="update.do" enctype="multipart/form-data">
				<div class="mb-3">
					<select name="qb_cat">
					    ...
					    <option value="0" <c:if test="${contentResult.boardq.qb_cat==0}">selected</c:if>>상품 문의</option>
					    <option value="1" <c:if test="${contentResult.boardq.qb_cat==1}">selected</c:if>>배송 문의</option>
					    <option value="2" <c:if test="${contentResult.boardq.qb_cat==2}">selected</c:if>>결제 문의</option>
					    <option value="3" <c:if test="${contentResult.boardq.qb_cat==3}">selected</c:if>>기타</option>
				  	</select>
				</div>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="m_email" value="${contentResult.boardq.m_email}" readonly>
				</div>
				<div class="mb-3">
					<label for="content">내용</label>
					<textarea class="form-control" rows="5" name="qb_content">${contentResult.boardq.qb_content}</textarea>
				</div>
				
			<div>
				<button type="button" value="전송" class="btn btn-sm btn-primary" onclick="check()">수정</button>
				<a href="list.do">
